    ...
    return (
        <div className="p-3">
            <div className="flex flex-col w-full rounded-2xl shadow-[0_0px_10px_-1px_rgba(0,0,0,0.3)]">
                <div className="flex md:static xxs:sticky xxs:top-0 md:backdrop-blur-none xxs:backdrop-blur-[12px] md:bg-inherit xxs:bg-white/[0.85] md:z-0 xxs:z-10 flex-row text-gray-600 items-center p-4 md:border-b border-gray-200 gap-x-2 border-solid">
                    <Link to="/">
